#!/bin/bash
# create_lab05.sh – Crea el Laboratorio 05 (Conmutación y VLANs)
...
LAB_DIR="$PROJECT_DIR/docs/labs/lab-05"
echo "📁 Creando laboratorio 05 en $LAB_DIR"
...
if grep -q "05 - Conmutación" "$MKCDOCS"; then
    echo "⚠️ El laboratorio 05 ya está registrado en mkdocs.yml. Omitiendo..."
else
    sed -i '/04 - Direccionamiento IP/a \      - '\''05 - Conmutación y VLANs'\'': '\''labs/lab-05/index.md'\''' "$MKCDOCS"
    echo "✅ Laboratorio 05 agregado a la navegación en mkdocs.yml"
fi

echo "✅ Laboratorio 05 creado exitosamente en $LAB_DIR"
