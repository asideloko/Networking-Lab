#!/bin/bash
# create_lab09.sh – Crea el Laboratorio 09 (VPN y Tunelización)
...
LAB_DIR="$PROJECT_DIR/docs/labs/lab-09"
echo "📁 Creando laboratorio 09 en $LAB_DIR"
...
if grep -q "09 - VPN" "$MKCDOCS"; then
    echo "⚠️ El laboratorio 09 ya está registrado en mkdocs.yml. Omitiendo..."
else
    sed -i '/08 - Seguridad en Redes/a \      - '\''09 - VPN y Tunelización'\'': '\''labs/lab-09/index.md'\''' "$MKCDOCS"
    echo "✅ Laboratorio 09 agregado a la navegación en mkdocs.yml"
fi

echo "✅ Laboratorio 09 creado exitosamente en $LAB_DIR"
