#!/bin/bash
# create_lab03.sh – Crea el Laboratorio 03 (Componentes de Red)
...
LAB_DIR="$PROJECT_DIR/docs/labs/lab-03"
echo "📁 Creando laboratorio 03 en $LAB_DIR"
...
if grep -q "03 - Componentes de Red" "$MKCDOCS"; then
    echo "⚠️ El laboratorio 03 ya está registrado en mkdocs.yml. Omitiendo..."
else
    sed -i '/02 - Transmisión de Datos/a \      - '\''03 - Componentes de Red y Conmutación'\'': '\''labs/lab-03/index.md'\''' "$MKCDOCS"
    echo "✅ Laboratorio 03 agregado a la navegación en mkdocs.yml"
fi

echo "✅ Laboratorio 03 creado exitosamente en $LAB_DIR"
