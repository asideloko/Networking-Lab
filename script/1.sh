#!/bin/bash
# create_lab01.sh – Crea el Laboratorio 01 (Fundamentos de Redes y Encapsulación)
...
LAB_DIR="$PROJECT_DIR/docs/labs/lab-01"
echo "📁 Creando laboratorio 01 en $LAB_DIR"
...
if grep -q "01 - Fundamentos de Redes" "$MKCDOCS"; then
    echo "⚠️ El laboratorio 01 ya está registrado en mkdocs.yml. Omitiendo..."
else
    sed -i '/Laboratorios:/a \      - '\''01 - Fundamentos de Redes y Encapsulación'\'': '\''labs/lab-01/index.md'\''' "$MKCDOCS"
    echo "✅ Laboratorio 01 agregado a la navegación en mkdocs.yml"
fi

echo "✅ Laboratorio 01 creado exitosamente en $LAB_DIR"
